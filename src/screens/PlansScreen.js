...
function PlansScreen() {
  ...
  // useEffect(() => {
  //   db.collectioin('customers')
  //     .doc(user.uid)
  //     .colection('subscription')
  //     .get()
  //     .then(querySnapshot => {
  ...
  //     if (error) {
  //       // show an error to your customer and inspect your Cloud Function logs inthe Firebase console.
  ...
  return (
    ...
    //         }>
    //           {isCurrentPackage ? 'Cureent Package' : 'Subscribe'}
    //         </button>
    //       </div>
    //     )
    //   })}
